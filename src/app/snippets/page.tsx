...
export default function Snippets() {
  ...
  const getStats = () => {
    return {
      ...
      shared: snippets.filter(s => s.isPublic).length,
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                  <div className="text-white">
                    ...
                    <p className="text-indigo-100 text-lg">
                      Organize, search, and manage your snippets efficiently
                    </p>
                  </div>
                  <Button 
          ...
          <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="relative p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">All your code</p>
                    </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl bg-white shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-pink-500/10 opacity-100 transition-opacity"></div>
                <div className="relative p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">Organized types</p>
                    </div>
            ...
            <div className="mb-8 space-y-6">
              ...
              <div className="relative max-w-2xl">
                ...
                <Input
                  ...
                  className="pl-12 pr-4 py-4 rounded-2xl border-gray-200 bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-lg"
                />
              </div>
              ...
              <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
                  ...
                  {showFilters && (
                    <div className="flex flex-wrap gap-3">
                      <select
                        ...
                        className="px-4 py-2 rounded-xl border border-gray-200 bg-white text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-transparent shadow-sm"
                      >
                ...
                <div className="flex items-center space-x-2 bg-white p-2 rounded-2xl shadow-lg border border-gray-200">
                  <Button
                    ...
                    size="sm"
                    className={`px-3 py-2 rounded-xl ${viewMode === "grid" ? 'bg-gradient-to-r from-indigo-500 to-purple-600 text-white' : ''}`}
                  >
                  ...
                  <Button
                    ...
                    size="sm"
                    className={`px-3 py-2 rounded-xl ${viewMode === "list" ? 'bg-gradient-to-r from-indigo-500 to-purple-600 text-white' : ''}`}
                  >
            ...
            {filteredSnippets.length === 0 && !loading && (
              <div className="text-center py-12">
                <FiCode className="h-16 w-16 text-gray-300 mx-auto mb-4" />
                ...
                {!searchTerm && selectedCategory === "all" && selectedTag === "all" && selectedFolder === "all" && (
                  <Button 
                    onClick={handleCreateSnippet}
                    className="bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white px-6 py-3 rounded-xl"
                  >
                    <FiPlus className="mr-2 h-5 w-5" />
                    Create Snippet
                  </Button>
